...
import { TooltipedControlCompoment, IProps } from "./TooltipedControl";


export class TooltipedControl implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	{
		return {
			value : this._props.value != null ? this._props.value: undefined
		};
	}
